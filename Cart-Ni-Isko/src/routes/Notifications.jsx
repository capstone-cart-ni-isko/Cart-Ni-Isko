...
function Notifications() {
  ...
  return (
    <AppShell showNav={false}>
      <div className="flex items-center justify-between px-5 py-4 border-b border-gray-50 bg-white sticky top-0 z-20">
        <div>
      ...
      <div className="pb-12 animate-fade-in">
        {items.length === 0 ? (
          ...
          <div className="divide-y divide-gray-50 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mx-4 my-2">
            {items.map((notif) => (
              <button
                key={notif.id}
                type="button"
              ...
              >
                <div className={`w-11 h-11 rounded-2xl flex items-center justify-center text-xl shrink-0 ${
                  !notif.read ? 'bg-brand-orange/10' : 'bg-gray-100'
                }`}>
