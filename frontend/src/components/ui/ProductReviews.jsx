    ...
    <div id="product-reviews" className="space-y-6 pt-4">
      ...
      {hasReviews ? (
        ...
        <div className="bg-gray-50/60 border border-dashed border-gray-200 rounded-3xl p-8 text-center max-w-lg mx-auto">
          ...
          <button
            ...
            className="mt-3 h-8 px-4 rounded-md bg-brand-orange text-white text-xs font-semibold hover:bg-brand-orange-dark active:scale-95 transition-all cursor-pointer"
          >
      ...
      {showWriteModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-fade-in">
          <div
            className="bg-white w-full max-w-md rounded-lg border border-slate-200 overflow-hidden p-4 animate-scale-in"
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="w-7 h-7 rounded-md bg-slate-100 border border-slate-200 text-gray-500 hover:text-gray-800 flex items-center justify-center cursor-pointer"
              >
            ...
            <form onSubmit={handleSubmitReview} className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs px-3 h-8 rounded-md border border-slate-200 focus:border-brand-orange outline-none transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full text-xs p-2.5 rounded-md border border-slate-200 focus:border-brand-orange outline-none transition-all resize-none"
                  required
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-1">
                <button
                  type="button"
                  onClick={() => setShowWriteModal(false)}
                  className="h-8 px-3 rounded-md border border-slate-200 bg-slate-100 text-xs font-semibold text-slate-700 hover:bg-slate-200 transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button
